...
U každého slova anglické věty, vidíme číslo klauze, do které patří -- tedy např. slovo \textit{mistake} patří do druhé klauze. Zarovnání je tvořeno páry odpovídajících slov číslovaných od nuly. Z páru \texttt{\color{blue}4}-{\color{red}5} vidíme, že páté slovo anglické věty (\textit{\color{blue}a}) odpovídá šestému slovu (\textit{\color{red}ein}) věty německé.

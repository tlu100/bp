...
\item{$V_{w_{i-1}}$ je množina slov pozorovaných po kontextu $w_{i-2}w_{i-1}$}
\end{itemize}
...
\section{Pozorování na konkrétních větách}
ruční analýza vět, přehled počtů chyb a vyhodnocení, které dělají překladu největší problémy
? POUŽÍT POZOROVANÉ N-BEST LISTY? ?



\chapter{Experimenty}
\footnotetext[1]{WORKSHOP ON STATISTICAL MACHINE TRANSLATION}
Data pro experimenty pochází z výstupů překladových systémů z WMT\footnotemark[1] 2006, které se účastnily překladu z angličtiny do němčiny. Některé z překladových hypotéz obsahovaly ručně ohodnocenou plynulost překladu. Právě tyto ohodnocené hypotézy používáme pro naše experimenty. Celkem jich je k dispozici 2028, z toho 58 je hodnoceno dvakrát a 2 třikrát, celkem tedy 2090 hodnocení. Následující tabulka ukazuje přesné počty hypotéz:
...
\footnotetext[2]{The SRI Language Modeling Toolkit}
\footnotetext[3]{Od verze 1.7.1 je toto rozšíření již součástí základní instalace SRILM toolkit.}
...
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-slova.eps}
	\includegraphics[width=60mm]{./grafy/max-6-slova.eps}
\end{center}
...
\begin{center}
	\includegraphics[width=70mm]{./grafy/porovnani-std-max-slova.eps}
\end{center}
...
\section{Modely se slovy nahrazenými morfologickými značkami}
...
\subsection{Rozšířený slovní druh + morfologické značky}
...
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-3-morf.eps}
	\includegraphics[width=60mm]{./grafy/std-6-morf.eps}	
	\\	* graf je blbě - prohozené barvy
	\includegraphics[width=70mm]{./grafy/porovnani-std-3-6-morf.eps}
\end{center}
Standardní 6-gramové modely dopadají o něco lépe, rozdíly však nejsou nijak výrazné. Podobné je to i u maxentových modelů:

\begin{center}		
	\includegraphics[width=60mm]{./grafy/max-3-morf.eps}	
	\includegraphics[width=60mm]{./grafy/max-6-morf.eps}
	\includegraphics[width=70mm]{./grafy/porovnani-max-3-6-morf.eps}
\end{center}

\begin{center}	
	\includegraphics[width=70mm]{./grafy/porovnani-std-max-3-morf.eps}
	\includegraphics[width=70mm]{./grafy/porovnani-std-max-6-morf.eps}	
\end{center}
...
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rod.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rod.eps}
\end{center}
\subsubsection{Rod stejný s předchozím}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rodstejny.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rodstejny.eps}
\end{center}
\subsection{Číslo}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-cislo.eps}
	\includegraphics[width=60mm]{./grafy/max-6-cislo.eps}
\end{center}
\subsection{Pád}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-pad.eps}
	\includegraphics[width=60mm]{./grafy/max-6-pad.eps}
\end{center}
\subsection{Rozšířený slovní druh}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rsd.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rsd.eps}
\end{center}
\subsection{Osoba + číslo}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-osoba+cislo.eps}
	\includegraphics[width=60mm]{./grafy/max-6-osoba+cislo.eps}
\end{center}
\subsection{Rozšířený slovní druh + rod}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rsd+rod.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rsd+rod.eps}
\end{center}
\subsection{Rozšířený slovní druh + pád}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rsd+pad.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rsd+pad.eps}
\end{center}
\subsection{Rozšířený slovní druh + číslo}
\begin{center}
	\includegraphics[width=60mm]{./grafy/std-6-rsd+cislo.eps}
	\includegraphics[width=60mm]{./grafy/max-6-rsd+cislo.eps}
\end{center}

\section{Modely s vlastní množinou rysů}
...
\subsection{Počet kořenů v naparsovaném stromu}
...
\subsection{Chybějící infinitiv s zu}
\subsection{Chybějící podmět}
\subsection{Chybějící určité sloveso}
\subsection{Infinitiv po modálním slovese není na konci věty}
\subsection{Podmět se neshoduje s přísudkem}
\subsection{Příčestí minulé bez pomocného slovesa}
\subsection{Příčestí minulé není na konci věty}
\subsection{Jména a slovesa ve více osobách}
\subsection{Více určitých sloves ve větě}
\subsection{Určité sloveso není ve vedlejší větě na konci}
\subsection{Součtové rysy}

...
U Pearsonova koeficientu bychom rádi dosáhli hodnoty blížící se k -1. Jedinou zápornou hodnotu má ale jen standardní n-gramový model natrénovaný na rozšířeném slovním druhu a všech morfologických značkách.

Směrnice přímky by měla být záporná, aby přímka klesala. Čím menší bude, tím bude klesat strměji a tím by měly být rozdíly v perplexitách jednotlivých plynulostí vyšší. Opět má nejlepší (nejnižší) hodnotu standardní model se slovním druhem a všemi značkami (tabulka \ref{tb:shrnutimorf}).

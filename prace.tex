...
Oba rysy vykazují závislost jejich hodnot s plynulostí (obrázky \ref{gr:sum}, \ref{gr:root}, \ref{gr:sumr}). Mediány mají pro různé plynulosti odlišné hodnoty (až na plynulosti 1 a 2). V následujících experimentech proto zkusíme, zda se dá predikovat plynulost třeba jen na základě mediánu vypočteného pro jednotlivé plynulosti v trénovacích datech.

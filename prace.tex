...
\item{natrénovat maxentový model s těmito rysy}
...
Jak vidíme z příkladu, druhý řádek nám říká, že hypotéza hodnocená plynulostí 4 má hodnotu rysu \texttt{chybi\_vfin} 0, \texttt{pp\_bez\_av} 0 a \texttt{chybi\_infszu} 1. Význam jednotlivých rysů bude ještě dále upřesněn, zde prozatím slouží jako příklad.

\section{Způsob vyhodnocení}
přesnost, lišící se o jedna + přehled nabízených fluency

\section{Vlastní rysy}
vždy napsat, jak se hledají - neznamenají vždy 100 \% to, jak se jmenují


\begin{figure}
  \centering
  \includegraphics[width=60mm]{./grafy/rysy/chybi_infszu.eps}
  \caption{Korelace plynulosti a hodnoty rysu chybi\_infszu}
  \label{chybiinfszu}
\end{figure}

\includegraphics[width=60mm]{./grafy/rysy/chybi_infszu.eps}
\includegraphics[width=60mm]{./grafy/rysy/chybi_podmet.eps}
\includegraphics[width=60mm]{./grafy/rysy/chybi_vfin.eps}

\includegraphics[width=70mm]{./grafy/rysy/chybi_sum.eps}


\includegraphics[width=60mm]{./grafy/rysy/inf_po_vm_neni_na_konci.eps}
\includegraphics[width=60mm]{./grafy/rysy/infszu_neni_na_konci.eps}
\includegraphics[width=60mm]{./grafy/rysy/vv_sloveso_neni_na_konci.eps}

\includegraphics[width=60mm]{./grafy/rysy/pp_neni_na_konci.eps}

\includegraphics[width=70mm]{./grafy/rysy/neni_na_konci_sum.eps}


\includegraphics[width=60mm]{./grafy/rysy/neshoda_podmet_prisudek.eps}
\includegraphics[width=60mm]{./grafy/rysy/pp_bez_av.eps}
...
\includegraphics[width=60mm]{./grafy/rysy/vice_osob.eps}
\includegraphics[width=60mm]{./grafy/rysy/vice_vfin.eps}

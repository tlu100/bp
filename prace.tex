...
\includegraphics[width=70mm]{./grafy/rysy/chybi_infszu.eps}
\includegraphics[width=70mm]{./grafy/rysy/chybi_podmet.eps}

\includegraphics[width=70mm]{./grafy/rysy/chybi_vfin.eps}
\includegraphics[width=70mm]{./grafy/rysy/chybi_sum.eps}


\includegraphics[width=70mm]{./grafy/rysy/inf_po_vm_neni_na_konci.eps}
\includegraphics[width=70mm]{./grafy/rysy/infszu_neni_na_konci.eps}

\includegraphics[width=70mm]{./grafy/rysy/vv_sloveso_neni_na_konci.eps}
\includegraphics[width=70mm]{./grafy/rysy/pp_neni_na_konci.eps}

\includegraphics[width=70mm]{./grafy/rysy/neni_na_konci_sum.eps}


\includegraphics[width=70mm]{./grafy/rysy/neshoda_podmet_prisudek.eps}
\includegraphics[width=70mm]{./grafy/rysy/pp_bez_av.eps}
...
\includegraphics[width=70mm]{./grafy/rysy/vice_osob.eps}
\includegraphics[width=70mm]{./grafy/rysy/vice_vfin.eps}
